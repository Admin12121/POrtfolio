...
const Angel = (props) => {
  ...
  const { actions } = useAnimations(animations, group)
   useEffect(()=>{actions.anim.reset().fadeIn(0.5).play();
          ...
          <group name="af2389e38ac94dd7969ba31a201058f2fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="Object_2">
              <group name="RootNode">
                ...
                <group name="glow_bg">
                <directionalLight intensity={2} color='silver' position={[0, 1, 0]} castShadow shadow-mapSize={2048} shadow-bias={-0.0001} />
